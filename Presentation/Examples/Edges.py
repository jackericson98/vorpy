...
cases = []
# Case 0: No overlap
cases.append([Atom([0.5, -np.sqrt(3)*np.pi/8, 0], 0.5), Atom([0.5, np.sqrt(3)*np.pi/8, 0], 0.5), Atom([-0.5, 0, 0], 0.5)])
...
cases.append([Atom([0.25, -np.sqrt(3)*np.pi/10, 0], .5), Atom([0.25, np.sqrt(3)*np.pi/10, 0], .5), Atom([-.25, 0, 0], .5)])
