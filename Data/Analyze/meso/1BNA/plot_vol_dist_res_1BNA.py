...
if __name__ == '__main__':
    ...
    #                                    prefix + '1BNA_coarse_scbb_ncap_pow_logs.csv'], avg_distros=True, by_residues=True)
    #
    ...
    titles = ['Atomistic', "Average Distance", 'Encapsulate', 'Sidechain/Backbone - Average Distance',
              'Sidechain/Backbone - Encapsulate', 'CG Martini']

    for i, file in enumerate(vols):
        labels = [_ for _ in vols[file]['nucs']]
        my_data = [[float(__) for __ in vols[file]['nucs'][_]] for _ in labels]
