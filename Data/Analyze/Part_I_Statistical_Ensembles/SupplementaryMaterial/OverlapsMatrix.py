        ...
        for i, ball in my_aw['atoms'].iterrows():
            ...
            for neighbor in ball['Neighbors']:
                ...
                if calc_dist(bloc, nloc) < nrad + brad:
                    ...
                    break
        print(len(my_aw['atoms']['Index']), len(olap_ndxs), len(set(olap_ndxs)), olap_ndxs)
...
def distribution_of_overlaps(my_dict=None, olap_value=0.5, bins=10):
