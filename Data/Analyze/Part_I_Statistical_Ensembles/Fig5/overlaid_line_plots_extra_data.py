...
y_label_dict = {0: 'File', 1: '# of Overlaps', 2: 'STD # of Overlaps', 3: '# of Overlaps',
                ...
                10: 'Standard Deviation in Absolute\n Difference in Neighbor #',
                11: 'Sphericity', 12: 'Sphericity', 13: 'Absolute % Difference\n Sphericity',
...
y_ranges = {0: [None, None], 1: [0, 10], 2: [0, 5], 3: [0, 3], 4: [0, 30], 5: [11.5, 15], 6: [11.5, 15], 7: [0, 27],
            8: [0, 32], 9: [0, 27], 10: [0, 30], 11: [0.80, 0.91], 12: [0.80, 0.91], 13: [0, 10], 14: [0, 12], 15: [0, 10],
            16: [0, 12], 17: [0, 3], 18: [0, 3], 19: [0, 50], 20: [0, 39], 21: [0, 34], 22: [0, 39]}
