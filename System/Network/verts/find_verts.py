...
def find_verts(alocs, arads, max_vert, net_type, check_atoms, a0=None, my_group=None, averts=None, vert_ndxs=None, vlocs=None,
    ...
    if len(group_atoms) == 4:
        ...
        v0 = find_v0(alocs=alocs, arads=arads, averts=averts, max_vert=max_vert, net_type=net_type, a0=a0, group_atoms=group_atoms, metrics=metrics)
    ...
    while vert_stack:
        ...
        while e_stack:
            ...
            vert_ndx_pr = find_site(edge_atoms=edge_atoms, alocs=alocs, arads=arads, averts=averts, vert_ndxs=vert_ndxs, max_vert=max_vert, net_type=net_type, vn_1=vert, group_atoms=group_atoms, metrics=metrics)
