...
def plot_data(ball_data):
    ...
    plt.plot(x, [0 for _ in x], c='black')

    plt.scatter(x, y_pw, c='blue', marker='x', alpha=0.3, s=20)
    plt.scatter(x, y_aw, c='red', marker='x', alpha=0.3, s=20)
    ...
    plt.yticks(fontsize=16, ticks=[-15, -10, -5, 0, 5, 10, 15], labels=[15, 10, 5, 0, 5, 10, 15])
