...
frame_variation_integrated_mean_curvature.png
frame_variation_integrated_mean_curvature.svg
"""
...
#
# Add additional metrics here later, for example:
#
# METRICS = [
#     "Integrated Mean Curvature",
