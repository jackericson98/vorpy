...
class MolecularView(QWidget):
    ...
    def _layer_scalar_limit(self, scheme: str, interpretation: str) -> float:
        ...
        return DisplayColors(self._layer_definitions.values())._layer_scalar_limit(scheme, interpretation)

    def _display_scalars(self, layer: GeometryLayer, raw: np.ndarray):
        from vorpy.workbench.services.display_colors import DisplayColors
        return DisplayColors(self._layer_definitions.values())._display_scalars(layer, raw)
